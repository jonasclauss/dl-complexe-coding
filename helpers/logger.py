...
class ReadableFormatter(logging.Formatter):
    def format(self, record):
        # Timestamp without milliseconds (YYYY-MM-DD HH:MM:SS)
        ...
        if hasattr(record, 'extra_data'):
            ...
            if isinstance(extra, dict):
                # Check if we have complex structures (like config dicts or lists)
                ...
                if has_complex:
                    ...
                    for k, v in extra.items():
                        if isinstance(v, (dict, list)):
                            try:
                                ...
                                # Indent lines for better readability
                    ...
                    # Inline for simple key-value pairs
